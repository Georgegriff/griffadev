...
<nav aria-label="Social Sharing">
  <ul class="social-share">
    ...
    {%- for link in external.sharing %}
        <li><a rel="noopener" class="icon-share url-share" title="{{link.text}}" target="_blank" href="{{link.url(title, tags, page) | url}}" class="action external">{% include link.icon %}</a></li>
    {%- endfor %}
  </ul>
</nav>
```
